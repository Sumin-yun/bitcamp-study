...
//=> prompt()를 실행한 후 사용자가 입력한 문자열을 리턴한다.  0
...
public class App {
  ...
  static void addMember() {
    ...
    for (int i = 0; i < pSize; i++) {      // 번호, 프로젝트명, 시작일, 종료일, 만든이
