...
public class ProjectHandler {
  ...
  public void add(MemberHandler memberHandler) {
    ...
    project.members = promptMember (memberHandler, null);
  ...
  public void update(MemberHandler memberHandler) {
    ...
    String members = promptMember(memberHandler, project.members);
  ...
  private String promptMember(MemberHandler memberHandler, String oldmember) {
    String members = "";
    while (true) {
